# START HERE — Codex Engineering System v1.3.2 繁體中文版
...
本 ZH-TW Edition 中文化的是使用者閱讀與發佈所需文件。`INSTALL_TO_YOUR_PROJECT/` 中實際控制 Codex 行為的規則維持 v1.3.2 英文版原文，以避免未重新驗證的翻譯改變 Routing / TDD / Verification 行為。

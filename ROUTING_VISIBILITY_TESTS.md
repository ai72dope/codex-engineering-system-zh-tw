# v1.3.2 Routing Visibility Regression Tests｜繁中說明
...
目前 v1.3.2 已觀察到：核心 Routing Decision 正確，但 Test A / B 類型情境的 Route Visibility 可能不穩定。因此這份測試保留作為 Regression Test，而不是宣稱目前已達 100% deterministic compliance。
